...
const primaryFont = Nunito({ subsets: ['latin'], weight: ["300", "300", "400", "500", "600", "700", "800", "900","1000"], display: "swap", variable: "--primary-font" })
const secondaryFont = Koulen({ subsets: ['latin'], weight: ["400"], display: "swap", variable: "--secondary-font" })
